<?php
    ...
    class Caption {
        ...
        public function Caption() {
            $this->labelBoxWidth = 30;
            $this->labelBoxHeight = 30;
        }
        ...
        public function render() {
            ...
            foreach ($this->labelList as $label) {
                ...
                $text->printText($img, $boxX2 + 5, $boxY1 + $this->labelBoxHeight / 2, $this->plot->getTextColor(), $label, $text->fontCondensed, $text->VERTICAL_CENTER_ALIGN, 15);
